...
//updating minecraft and forge is as easy as updating the version in the gradle file:)
when updating minecraft and forge you need to type command (gradlew clean) this is very important before anything else
next (gradlew DecompWorkspace)
Last (gradlew idea)
reload the project and there you go:)
